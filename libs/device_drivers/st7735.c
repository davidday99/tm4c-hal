...
// **********ST7735 TFT and SDC*******************
// ST7735
// LED+ connected to +3.3 V
// CS connected to PA3 (SSI0Fss)
// SCL conected to PA2 (SSI0Clk)
// SDA connected to PA5 (SSI0Tx)
// A0 connected to PA6 (GPIO), high for data, low for command
// RESET conntected to PA7 (GPIO)
